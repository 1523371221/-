...
m = 100
# 读取图像
ImageL = cv2.imread('L_0.png')
ImageR = cv2.imread('R_0.png')
...
# 立体校正
R1, R2, P1, P2, Q, roi1, roi2 = cv2.stereoRectify(left_camera_matrix, left_distortion, right_camera_matrix, right_distortion, size, R, T, flags=cv2.CALIB_ZERO_DISPARITY, alpha=0)
...
cv2.createTrackbar('sigmaColor', 'depth', 400, 1000, lambda x: None)
